...
#[cfg(test)]
use prompt::{build_chat_context_system_prompt, build_quick_system_prompt, build_system_prompt};
use prompt::{
...
mod chat_search;
use chat_search::{build_chat_search_pending_request, chat_search_rebuilding_message};
#[cfg(test)]

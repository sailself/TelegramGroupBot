...
pub fn built_in_core_workspace_skill() -> SkillDoc {
    let body = [
        ...
        "5. Use `memory_store` to persist facts/preferences/tasks that should survive runs.",
        "6. Use `memory_recall` to fetch relevant context before complex multi-step work.",
        "7. Use `memory_forget` only when stale/incorrect memory should be removed.",
        "",
        "Failure handling:",

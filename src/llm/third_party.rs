...
fn provider_runtime_config(provider: ThirdPartyProvider) -> Result<ProviderRuntimeConfig> {
    let config = match provider {
        ThirdPartyProvider::OpenRouter => ProviderRuntimeConfig {
            ...
            top_k: CONFIG.openrouter.top_k,
            request_timeout_secs: CONFIG.openrouter.request_timeout_secs,
        },
        ThirdPartyProvider::Nvidia => ProviderRuntimeConfig {
            provider,
            display_name: "NVIDIA",
            base_url: CONFIG.nvidia.base_url.clone(),
            api_key: CONFIG.nvidia.api_key.clone(),
            temperature: CONFIG.nvidia.temperature,
            top_p: CONFIG.nvidia.top_p,
            top_k: None,
            request_timeout_secs: CONFIG.nvidia.request_timeout_secs,
        },
        ThirdPartyProvider::Ollama => ProviderRuntimeConfig {
            provider,
            display_name: "Ollama",
            base_url: CONFIG.ollama.base_url.clone(),
            api_key: CONFIG.ollama.api_key.clone(),
            temperature: CONFIG.ollama.temperature,
            top_p: CONFIG.ollama.top_p,
            top_k: None,
            request_timeout_secs: CONFIG.ollama.request_timeout_secs,
        },

...
#[cfg(test)]
use crate::llm::runtime_models::codex_selected_model_label;
use crate::llm::runtime_models::{
    runtime_model_config, runtime_model_count, runtime_models, ResolvedExplicitCodexModel,
};
use crate::llm::text_model::{
    has_available_third_party_models_for_request, model_supports_media_for_request,
    normalize_model_identifier, ready_runtime_providers, resolve_default_text_model_for_request,
...
mod trigger;
#[cfg(test)]
use trigger::should_auto_q_trigger_with_config;
...
use model_resolution::{
    add_explicit_quick_model, resolve_prepared_quick_text_model_with_models,
    resolve_quick_text_model_with_models, ExplicitCodexReadiness,
};
use model_resolution::{
    codex_quick_result_label, configured_model_display_name, default_model_selection_key,
    format_llm_error_message, resolve_quick_text_model_for_request, result_model_display_name,
    selectable_model_ids_for_request, selectable_model_ids_for_request_with_models,
    should_use_default_model_without_selection, third_party_provider_label,
    video_request_has_capable_model,
};

mod chat_search;
use chat_search::{
    build_chat_search_pending_request, chat_search_rebuilding_message, process_chat_search_request,
    warn_on_unverified_chat_links,
};
#[cfg(test)]
use chat_search::{parse_chat_search_selection, unverified_chat_link_ids};

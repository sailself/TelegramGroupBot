...
pub struct Config {
    ...
    pub acl_file_path: String,
    pub acl_reload_ttl_seconds: u64,
...
impl Config {
    pub fn load() -> Result<Self> {
        ...
        Ok(Config {
            ...
            acl_file_path: env_string("ACL_FILE_PATH", "acl.json"),
            acl_reload_ttl_seconds: env_u64("ACL_RELOAD_TTL_SECONDS", 2),
            acl_enforced: env_bool("ACL_ENFORCED", true),
